...
def voice_attendance_dialog(selected_subject_id):
    st.write("Record audio of students saying I am present. Then AI recognize the students")
    ...
    if st.button("Analyze Audio", width='stretch', type='primary'):
        with st.spinner("Processing Audio data"):
            ...
            deteced_scores = process_bulk_audio(audio_bytes, candidates_dict)
            ...
            for node in enrolled_students:
                ...
                score = deteced_scores.get(student['student_id'], 0.0)
